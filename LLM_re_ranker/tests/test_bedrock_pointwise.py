...
class BedrockPointwiseRankerTests(unittest.TestCase):
    def test_reranks_using_normalized_yes_no_logprobs(self):
        ...
        self.assertAlmostEqual(2.0, ranker.last_document_scores["a"]["logit_margin"])
        self.assertAlmostEqual(0.880797, ranker.last_document_scores["a"]["score"], places=5)
        self.assertAlmostEqual(-1.0, ranker.last_document_scores["b"]["logit_margin"])
